...
//     use super::*;       
//     use cosmwasm_std::{ContractResult, to_vec, QueryRequest, Empty, Coin, BalanceResponse, QuerierResult, from_slice, Querier, BankQuery, SystemResult::{Err, self}};
//     use serde::de::DeserializeOwned;
//     use shadeswap_shared::{snip20::helpers::TokenInfo, core::{Fee, TokenPair, CustomFee}};
...
//     //         QuerierResult::Ok(ContractResult::Ok(from_binary("")))
//     //     }
...
//     //                             },
//     //                             CUSTOM_TOKEN_1 =>{
//     //                                 let result = cosmwasm_std::ContractResult::Ok(
//     //                                     to_binary(&IntBalanceResponse {
//     //                                         balance: Balance{
//     //                                             amount: Uint128::from(10000),
//     //                                         },
...
//     //                                         decimals: 18,
//     //                                         symbol: "LP".to_string(),
//     //                                         total_supply: Some(Uint128::from(10000))
//     //                                     }
//     //                                 }
//     //                                 )));
//     //                                 QuerierResult::Ok(result)
...
//     //                                     }
//     //                                 )));
//     //                                 QuerierResult::cosmos_std::Ok(result)
//     //                             }, 
//     //                             "cosmos2contract" => {
//     //                                 let result = cosmwasm_std::SystemResult::Ok(cosmwasm_std::ContractResult::Ok(
//     //                                     to_binary(&BalanceResponse{
...
//     //     ) -> StdResult<Binary>  {
//     //         // let raw = match to_vec(request) {
//     //         //     cosmwasm_std::SystemResult::Ok(raw) => raw,
//     //         //     Err(e) => {
//     //         //         return Err(StdError::generic_err(format!(
//     //         //             "Serializing QueryRequest: {}",
//     //         //             e
...
//     //         //     //     },
//     //         //     // }))
//     //         //     // Ok(cosmwasm_std::SystemResult::Err(err)) => Err(cosmwasm_std::SystemError::from("error")),
//     //         //     // in theory we would process the response, but here it is the same type, so just pass through
//     //         //     // Ok(cosmwasm_std::SystemResult::Ok(res)) => from_binary(&res),
//     //         // }
//     //         to_binary(&"test")
...
//             custom_fee: custom_fee,
//         };         
//         assert!(instantiate(deps.as_mut(), env.clone(),mock_info, msg).is_ok());
//         let config = config_r(deps.as_mut().storage).load()?;    // set staking contract
...
//     fn mock_contract_info(address: &str) -> ContractLink{
//         ContractLink{
//             address :Addr::unchecked(address.clone()),
//             code_hash: "".to_string()
//         }
